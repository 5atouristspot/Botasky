...
@module: moosefs mfsmetalogger
@used: monitor the node of moosefs mfsmetalogger
"""
...
def mfsmetalogger():
    ...
    mail_subject = 'MFS:mfsmetalogger alert'
    alert_info = message_info('MFS:mfsmetalogger', admin, business, monitor_ip, monitor_port)
