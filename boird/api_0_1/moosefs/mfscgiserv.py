...
@module: moosefs mfscgiserv
@used: monitor the node of moosefs mfscgiserv
"""
...
def mfscgiserv():
    ...
    mail_subject = 'MFS:mfscgiserv alert'
    alert_info = message_info('MFS:mfscgiserv', admin, business, monitor_ip, monitor_port)
